...
{
   public class CorporateBrandingModel
    {
        public int CorporateBrandingId { get; set; }
        public int? BusinessUserId { get; set; }
        public string BusinessName { get; set; }
       [Required(ErrorMessage="Enter Details")]
        public string CorporateBrandDetails { get; set; }
        ...
        public List<CorporateBrandingModel> CorporateBrandingList { get; set; }
    }
}
